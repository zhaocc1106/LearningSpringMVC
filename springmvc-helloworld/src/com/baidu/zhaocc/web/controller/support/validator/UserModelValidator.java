package com.baidu.zhaocc.web.controller.support.validator;
...
public class UserModelValidator implements Validator {
	...
	public boolean supports(Class<?> clazz) {
		return UserModule.class == clazz;// 表示只对UserModel类型的目标对象实施验证
	}
	...
	public void validate(Object target, Errors errors) {
		...
		UserModule user = (UserModule) target;
		if (!USERNAME_PATTERN.matcher(user.getUserName()).matches()) {
			errors.reject("userName", "username.not.illegal");// 如果用户名不合法
		}
