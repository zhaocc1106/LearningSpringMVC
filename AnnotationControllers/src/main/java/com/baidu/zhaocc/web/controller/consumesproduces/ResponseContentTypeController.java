...
public class ResponseContentTypeController {
    ...
    @RequestMapping("/produces/ContentType")
    ...
    @RequestMapping(value = "/produces/ContentType", produces = "application/json")
    ...
    @RequestMapping(value = "/produces/ContentType", produces = "application/xml")
