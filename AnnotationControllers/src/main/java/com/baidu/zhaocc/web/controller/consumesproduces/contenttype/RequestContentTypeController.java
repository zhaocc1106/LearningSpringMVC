package com.baidu.zhaocc.web.controller.consumesproduces.contenttype;
...
public class RequestContentTypeController {
	...
	@RequestMapping(value = "consumers/requestContentType", method = RequestMethod.GET)
	public String showForm() throws IOException{
		return "consumers/requestContentType";
	}

	@RequestMapping(value = "consumers/requestContentType", method = RequestMethod.POST,
